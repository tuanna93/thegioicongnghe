                    ...
                    <div class="x_content">
                        ...
                        <form action="" method="post" class="form-horizontal form-label-left" enctype="multipart/form-data">
                            ...
                            <div class="panel panel-default">
                                     <div class="panel-heading">Thông tin trang web</div>
                                    ...
                                    <div class="form-group">
                                     ...
                                     <div class="form-group">
                                          ...
                                          <a id="ckfinder-popup" class="btn btn-primary col-md-1" onclick="selectFileWithCKFinder('ckfinder-input-2')">Browse</a>
                                      </div>
                                 </div>
                            </div>
                            <div class="panel panel-default">
                                 <div class="panel-heading">Cấu hình SEO</div>
                                 <div class="panel-body">
                                     <div class="form-group">
                                          <label class="control-label col-md-3 col-sm-3 col-xs-12">Keywords ( SEO )</label>
                                          <div class="col-md-9 col-sm-9 col-xs-12">
                                     ...
                                     <div class="form-group">
                                      ...
                                      <div class="form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12">H1 ( SEO )</label>
                                            <div class="col-md-9 col-sm-9 col-xs-12">
                             ...
                             <div class="panel panel-default">
                              ...
                              <div class="panel panel-default">
                                    <div class="panel-heading">Footer trang</div>
                                    <div class="panel-body">
                                     <div class="form-group">
                                         <label class="control-label col-md-3 col-sm-3 col-xs-12">Footer trang ( Trái )</label>
                                         <div class="col-md-9 col-sm-9 col-xs-12">
                                     ...
                                     <div class="form-group">
                                          <label class="control-label col-md-3 col-sm-3 col-xs-12">Footer trang ( Phải )</label>
                                          <div class="col-md-9 col-sm-9 col-xs-12">
